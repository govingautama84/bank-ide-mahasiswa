...
$stats['ideas'] = $pdo->query("SELECT COUNT(*) FROM ide")->fetchColumn();
$stats['categories'] = $pdo->query("SELECT COUNT(*) FROM kategori")->fetchColumn();
$stats['comments'] = $pdo->query("SELECT COUNT(*) FROM komentar")->fetchColumn();
